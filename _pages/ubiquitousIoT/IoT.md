...
<br>
<p align="justify"> RF signal generation is expensive and takes a lot of power. Hitchhike tackles this problem by recycling the ambient RF signals reembed the data from an IoT device. </p>
</div>
...
<div class="container">
    <a style="display: inline-block;" href="{{ site.url }}{{ site.baseurl }}/files/sensys16_back_comm.pdf">HitchHike: Practical Backscatter using Commodity WiFi</a><br>
    <b>Pengyu Zhang</b> (Co-primary), Dinesh Bharadia (Co-primary), Kiran Joshi, Sachin Katti<br>
    SenSys 2016<br>
...
<div class="container">
    <a style="display: inline-block;" href="{{ site.url }}{{ site.baseurl }}/ISSCC_paper.pdf">A 28μW IoT Tag That Can Communicate with Commodity WiFi Transceivers</a><br>
