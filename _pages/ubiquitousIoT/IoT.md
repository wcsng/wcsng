...
<div class="row">
<div class="col-sm-9 clearfix">
<a href="{{ site.url }}{{ site.baseurl }}/files/sensys16_back_comm.pdf" style="background-color: white; color: orange;">HitchHike: Practical Backscatter using Commodity WiFi</a><br>
<b>Pengyu Zhang</b> (Co-primary), Dinesh Bharadia (Co-primary), Kiran Joshi, Sachin Katti<br>SenSys 2016<br> 
