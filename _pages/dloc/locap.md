...
#### <a href="{{ site.url }}{{ site.baseurl }}/files/LocAP_paper.pdf" style="background-color: white; color: orange;">[Paper]</a> <a href="{{ site.url }}{{ site.baseurl }}/files/LocAP_NSDI_slides.pdf" style="background-color: white; color: orange;">[Slides]</a> [Video]
